...
REQUIRED_FILES = (
    ...
    "music_vault/core/acquisition_runtime.py",
    "music_vault/core/acquisition_diagnostics.py",
    "music_vault/core/transport_actions.py",
    "music_vault/core/listening_schema.py",
    "music_vault/core/listening_store.py",
    "music_vault/core/listening_history.py",
    "music_vault/ui/listening_history.py",
    "music_vault/ui/listening_library.py",
    "music_vault/ui/windows_transport.py",
    "music_vault/platform/windows_taskbar.py",
    "music_vault/platform/windows_smtc.py",
    "tools/dev/verify_acquisition.py",
    ...
    "music_vault/metadata/evidence.py",
    "music_vault/metadata/resolver.py",
    "music_vault/metadata/materializer.py",
    "music_vault/metadata/resolution_schema.py",
